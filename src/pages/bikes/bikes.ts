...
export class BikesPage {
 ...
 // this.leftdays = 2;
  ...
  public bikeviewDetail(search) {
    ...
    this.navCtrl.push(BikedetailsPage,{search,bikesearchList: this.bikesearchList,searchbikevalues:this.searchbikevalues,locationinfoList:this.locationinfoList,hours:this.hours,leftdays:this.leftdays});
