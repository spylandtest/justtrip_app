...
/*
  Generated class for the BikepaymentserviceProvider provider.

  See https://angular.io/guide/dependency-injection for more info on providers
  and Angular DI.
*/
@Injectable()
export class BikepaymentserviceProvider {

  constructor(public http: Http) {
    console.log('Hello BikepaymentserviceProvider Provider');
  }
  public paymentcomplete(payment_id,bikeuserDetails,paymentList) 
  {
 ...
 // let endPoint = 'http://thecityshoppers.com/distribution';
  ...
  //     let data = "tripType="+searchvalues.tripType+"&leavingFrom="+searchvalues.leavingFrom+"&goingTo="+searchvalues.goingTo+"&date="+searchvalues.date+"&returnDate="+searchvalues.returnDate+"&numAdult="+searchvalues.numAdult+"&preferTime="+searchvalues.preferTime;
       ...
       let data ="payment_id="+payment_id+"&name="+bikeuserDetails.name+"&email="+bikeuserDetails.email+"&mobileno="+bikeuserDetails.mobileno+
       "&bookingId="+paymentList.bookingId+"&email="+paymentList.email+"&finalPrice="+paymentList.finalPrice+"&location="+paymentList.location+"&pickupdate="+paymentList.pickupdate+"&dropdate="+paymentList.dropdate+"&amountToPayadv="+paymentList.amountToPayadv;
       console.log(data);
    //  var self =  this ;
